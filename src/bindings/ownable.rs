...
mod ownable_mod {
    ...
    use std::sync::Arc;
    pub static OWNABLE_ABI: ethers_contract::Lazy<ethers_core::abi::Abi> =
    ...
    impl<M: ethers_providers::Middleware> std::fmt::Debug for Ownable<M> {
    ...
    impl<'a, M: ethers_providers::Middleware> Ownable<M> {
        ...
        pub fn new<T: Into<ethers_core::types::Address>>(
            ...
            let contract =
                ethers_contract::Contract::new(address.into(), OWNABLE_ABI.clone(), client);
            Self(contract)
        }
