...
mod erc20_mod {
    ...
    impl<M: ethers_providers::Middleware> std::fmt::Debug for ERC20<M> {
    ...
    impl<'a, M: ethers_providers::Middleware> ERC20<M> {
        ...
        pub fn new<T: Into<ethers_core::types::Address>>(
            ...
            let contract =
                ethers_contract::Contract::new(address.into(), ERC20_ABI.clone(), client);
            Self(contract)
        }
        ...
        pub fn events(&self) -> ethers_contract::builders::Event<M, ERC20Events> {
    ...
    impl ethers_core::abi::Tokenizable for ERC20Events {
        fn from_token(
    ...
    impl ethers_core::abi::TokenizableItem for ERC20Events {}
