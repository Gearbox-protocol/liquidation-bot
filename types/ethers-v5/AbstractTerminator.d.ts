...
interface AbstractTerminatorInterface extends ethers.utils.Interface {
  functions: {
...
export class AbstractTerminator extends BaseContract {
  ...
  interface: AbstractTerminatorInterface;
